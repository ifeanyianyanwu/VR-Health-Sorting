...
//     public Transform tableStandPosition;
...
//         if (GameManager.Instance.ResetGame(foodSpawner, this, tableStandPosition))
//         {    
//             startButton.gameObject.SetActive(false);
//         }
...
//         });
//         resetButton.onClick.AddListener(() => GameManager.Instance.ResetGame(foodSpawner, this, tableStandPosition));
//     }
//     public void SetIncorrectFoodCount(string foodName, bool isHealthy)
//     {
//         incorrectFoodCount++;
